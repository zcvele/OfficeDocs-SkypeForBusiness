...
|User management  |-Manage users list page</br>-User details page</br>--Account tab</br>--Meetings and calls</br>--Policies</br>--Devices tab |NA |-Manage users list page</br>-User details page</br>--Account tab</br>--Meetings and calls</br>--Policies</br>--Voice</br>--Voicemail |-Manage users list page</br>-User details page</br>--Account tab</br>--Meetings and calls</br>-Policies</br>|-Manage users list page</br>-User details page</br>--Meetings and calls |-Manage users list page</br>-User details page</br>--Meetings and calls |
|Devices management |The entire devices section (seven options) |The entire devices section (seven options) |NA |NA |NA |NA |
|Policy management  |Option to only perform user or group policy assignments for the following policies:</br>-Audio conferencing</br>-Meeting</br>-Customization</br>-Live events</br>-Events</br>-Messaging</br>-Calling</br>-Call hold</br>-Call park</br>-Caller ID</br>-Dial Plans</br>-Shared Calling</br>-Mobility</br>-Voice routing</br>-Voicemail</br>-Voice applications|-Dial NA |Option to only perform user or group policy assignments for the following policies:</br>-Audio conferencing</br>-Meeting</br>-Customization</br>-Live events</br>-Events</br>-Calling</br>-Call hold</br>-Call park</br>-Caller ID</br>-Dial Plans</br>-Shared Calling</br>-Mobility</br>-Voice routing</br>-Voicemail</br>-Voice applications |Option to only perform user or group policy assignments for the following policies: </br>-Calling</br>-Call Hold</br>-Call park</br>-Caller ID</br>-Dial Plans</br>-Shared Calling</br>-Mobility</br>-Voice routing</br>-Voice mail</br>-Voice applications|NA |NA |
|Voice management |Phone Number assignment – From User Details Page (Only Direct Routing numbers) |NA |Phone Number assignment – From User Details Page (Only Direct Routing numbers) |Phone Number assignment - From User Details Page (Only Direct Routing numbers)|NA |NA |
|Analytics and reporting management |-Usage reports (only PSTN reports</br>)-Call quality dashboard (UII info redacted) |NA |-Usage reports (only PSTN reports</br>)-Call quality dashboard (UII info redacted) |-Usage Reports (only PSTN reports)|Call quality dashboard (UII info redacted) |Call quality dashboard (UII info redacted) |
