...
| No one | Specific users/groups can install | Specific users and groups |
| Specific users and groups | All users in the organization can install | Everyone |
| Specific users and groups (example: Marketing, Legal) | Specific users/groups can install (example: Marketing, Design) | Specific users and groups (example: Legal, Design, Marketing) |
| Specific users and groups | No user in the organization can install | Specific users and groups |
| Everyone | All users in the organization can install | Everyone |
| Everyone | No user in the organization can install | Everyone |
| Everyone | Specific users or groups can install | Everyone |
...
|----|----|----|
| No one | - | No one |
| No one | Specific users or groups | Specific users and groups |
| No one | Entire organization | Everyone |
| Specific users and groups | - | Specific users and groups |
| Specific users and groups (example: Marketing, Legal) | Specific users or groups (example: Marketing, Design) | Specific users and groups (example: Legal, Design, Marketing) |
| Specific users and groups | Entire organization | Everyone |
| Everyone | - | Everyone |
| Everyone | Specific users or groups | Everyone |
