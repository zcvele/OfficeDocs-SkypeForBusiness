...
Alternatively, you may find it easier to enable notifications for groups of users at once using PowerShell. For more information, see [Grant-CsTeamsUpgradePolicy](/powershell/module/teams/grant-csteamsupgradepolicy).
...
Alternatively, you may find it easier to upgrade groups of users at once using PowerShell. For more information, see [Grant-CsTeamsUpgradePolicy](/powershell/module/teams/grant-csteamsupgradepolicy).
