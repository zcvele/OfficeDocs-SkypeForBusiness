...
:::image type="content" source="media/team-targeting-schema-example-new.png" alt-text="Example of a team hierarchy":::

## Create your hierarchy

> [!NOTE]
> The remainder of this article discusses setting up a team hierarchy in the context of publishing tasks to recipient teams. Refer to [Manage the Planner app for your organization in Teams](./manage-planner-app.md) for an overview of the Planner app, where task publishing appears when enabled.
...
You can upload a new hierarchy to replace the old one using the same PowerShell command as described earlier. Each time you upload a new hierarchy, it replaces the previous hierarchy.
...
Make sure that the TeamId in your schema CSV file matches the Group ID displayed in the Teams admin center.

## Related articles

* [Manage the Planner app for your organization in Teams](manage-planner-app.md)
